...
{#if owned.length === 0}
  <div class="text-center py-12 text-gray-500">
    ...
    <p class="text-sm text-pretty"><a href={`${base}cards/`} class="text-gray-900 underline underline-offset-2 decoration-gray-400 hover:decoration-gray-900">衣装一覧</a>で所持数を登録してください</p>
  </div>
{:else}
  <div>
